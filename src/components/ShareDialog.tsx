...
const SESSION_MONTH_KEY = 'shareDialogMonth';

const getSessionMonth = (fallback: string): string =>
    sessionStorage.getItem(SESSION_MONTH_KEY) ?? fallback;

const saveSessionMonth = (month: string) => {
    sessionStorage.setItem(SESSION_MONTH_KEY, month);
};
